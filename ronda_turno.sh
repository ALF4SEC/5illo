...
then
    ...
    then
        if test ${BASTOS[4]} -ne 0
        then
            if test ${JUGADOR2[$I]} -gt ${BASTOS[$PIVOTE_SUPB]} -a ${JUGADOR2[$I]} -eq $((${BASTOS[$PIVOTE_SUPB]}+1)) -o ${JUGADOR2[$I]} -lt 
${BASTOS[$PIVOTE_INFB]} -a ${JUGADOR2[$I]} -eq $((${BASTOS[$PIVOTE_INFB]}-1))
            then
                PUEDE=1
            else
                I=$(($I+1))
    ...
    then
        if test ${COPAS[4]} -ne 0
        then
            if test ${JUGADOR2[$I]} -gt ${COPAS[$PIVOTE_SUPC]} -a ${JUGADOR2[$I]} -eq $((${COPAS[$PIVOTE_SUPC]}+1)) -o ${JUGADOR2[$I]} -lt 
${COPAS[$PIVOTE_INFC]} -a ${JUGADOR2[$I]} -eq $((${COPAS[$PIVOTE_INFC]}-1))
            then
                PUEDE=1
            else
                I=$(($I+1))
    ...
    then
        if test ${OROS[4]} -ne 0
        then
            if test ${JUGADOR3[$I]} -gt ${OROS[$PIVOTE_SUPO]} -a ${JUGADOR3[$I]} -eq $((${OROS[$PIVOTE_SUPO]}+1)) -o ${JUGADOR3[$I]} -lt 
${OROS[$PIVOTE_INFO]} -a ${JUGADOR3[$I]} -eq $((${OROS[$PIVOTE_INFO]}-1))
            then
                PUEDE=1
            else
                I=$(($I+1))
    ...
    then
        if test ${ESPADAS[4]} -ne 0
        then
            if test ${JUGADOR3[$I]} -gt ${ESPADAS[$PIVOTE_SUPOE]} -a ${JUGADOR3[$I]} -eq $((${ESPADAS[$PIVOTE_SUPE]}+1)) -o ${JUGADOR3[$I]} -lt 
${ESPADAS[$PIVOTE_INFE]} -a ${JUGADOR3[$I]} -eq $((${ESPADAS[$PIVOTE_INFE]}-1))
            then
                PUEDE=1
            else
                I=$(($I+1))
    ...
    then
        if test ${BASTOS[4]} -ne 0
        then
            if test ${JUGADOR3[$I]} -gt ${BASTOS[$PIVOTE_SUPB]} -a ${JUGADOR3[$I]} -eq $((${BASTOS[$PIVOTE_SUPB]}+1)) -o ${JUGADOR3[$I]} -lt 
${BASTOS[$PIVOTE_INFB]} -a ${JUGADOR3[$I]} -eq $((${BASTOS[$PIVOTE_INFB]}-1))
            then
                PUEDE=1
            else
                I=$(($I+1))
    ...
    then
        if test ${COPAS[4]} -ne 0
        then
            if test ${JUGADOR3[$I]} -gt ${COPAS[$PIVOTE_SUPC]} -a ${JUGADOR3[$I]} -eq $((${COPAS[$PIVOTE_SUPC]}+1)) -o ${JUGADOR3[$I]} -lt 
${COPAS[$PIVOTE_INFC]} -a ${JUGADOR3[$I]} -eq $((${COPAS[$PIVOTE_INFC]}-1))
            then
                PUEDE=1
            else
                I=$(($I+1))
